 ...
 * E2E Test API Client
 *
 * HTTP client for the current REST envelope (`success`, `data`,
 * `pagination`).
 */
...
export class ApiClient {
  ...
  /** POST /api/v1/cis — returns the canonical CI shape. */
  ...
  async listCIs(
    ...
    return {
      ...
      total: (response.data.pagination as Record<string, unknown>).total as number,
    };
  }

  /** POST /api/v1/cis/search — body { query }; returns data array. */
  ...
  /** POST /api/v1/relationships — returns data. */
  ...
  /** GET /api/v1/cis/:id/relationships — returns data array. */
  ...
  /** GET /api/v1/cis/:id/impact?depth= — returns data object. */
